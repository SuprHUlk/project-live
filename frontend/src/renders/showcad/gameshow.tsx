...
import imgjs from "../../assets/games.jpg";
...
export default function gameshow({ openAlert }: Props) {
    ...
    <div className="w-[82%] h-[92vh] absolute top-[8vh] left-[18%] bg-[#0E0E10] overflow-auto">
      <div className="w-[100%] h-max">
        <div className="w-[100%] h-[30vh]  flex">
          ...
          <div className="ml-5">
            <div className="text-3xl font-bold m-2">GAMING</div>
            <div className="font-bold m-2">0 Viewer</div>
            <div className="m-2 w-[50%] h-[5vh] bg-blue-800/40 rounded-3xl flex justify-center items-center">
              Gaming
            </div>
          </div>
